...
import { jurnalUmumGetJurnalById } from "../jurnal-umum-components/JurnalUmumService";

export default function JurnalUmumJurnalId({ id, onClose }) {
  ...
  useEffect(() => {
    const fetchJurnalData = async () => {
      const response = await jurnalUmumGetJurnalById(id);
      if (response.success) {
    ...
    <div className="relative">
      ...
      <Dialog open={isOpen} onOpenChange={handleOnClose}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogTitle>Jurnal Umum</DialogTitle>
