...
import { kontakClientEndpoint } from "./KontakService";
import { useDialog, useDialogDispatch } from "@/dialogs/DialogProvider";
import {
  useClient,
  useClientDispatch,
} from "@/app/management/perubahan-profil/perubahan-profil-components/PerubahanProfilProvider";
import KontakUpdateForm from "@/app/management/perubahan-profil/tabs/kontak/kontak-pages/KontakUpdateForm";
import LoaderOverlay from "@/components/custom/loader-overlay";
import { useLocalStorage } from "@/hooks/use-local-storage";

export default function KontakAction({ row }) {
  ...
  return (
    <div className="relative">
      ...
      {onUpdate && (
        <KontakUpdateForm id={item._id} onClose={() => setOnUpdate(false)} />
      )}
