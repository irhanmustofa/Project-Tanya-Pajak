...
import { nomorEksternalEndpoint } from "./NomorEksternalService";
import { useDialog, useDialogDispatch } from "@/dialogs/DialogProvider";
import {
  useClient,
  useClientDispatch,
} from "@/app/management/perubahan-profil/perubahan-profil-components/PerubahanProfilProvider";
import NomorEksternalUpdateForm from "@/app/management/perubahan-profil/tabs/nomor-eksternal/nomor-eksternal-pages/NomorEksternalUpdateForm";
import LoaderOverlay from "@/components/custom/loader-overlay";
import { useLocalStorage } from "@/hooks/use-local-storage";

export default function NomorEksternalAction({ row }) {
  ...
  const handleDelete = (id) => {
    dispatch({
      ...
      payload: {
        isOpen: true,
        title: "Delete Data Nomor Identifikasi Eksternal",
        message:
          "Are you sure you want to delete this user? This action cannot be undone.",
        status: "warning",
        url: nomorEksternalEndpoint.delete(id),
      },
    });
  };
