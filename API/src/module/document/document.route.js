...
documentRouter
  .route("/delete")
  .post(checkPermission("documents.delete"), Controller.deleteSome);
documentRouter
  .route("/")
  .get(checkPermission("documents.read"), Controller.getAll)
  .post(checkPermission("documents.create"), Controller.create);
documentRouter
  .route("/:id")
