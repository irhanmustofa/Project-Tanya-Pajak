...
export default function SaldoAwalUpdateForm({ id, onClose }) {
  ...
  const { saldoAwalAction, saldoAwalState, coas } = useSaldoAwal();
  ...
  useEffect(() => {
    const data = saldoAwalState.data.find((item) => item._id === id);
  ...
  const handleSubmit = (event) => {
    ...
    startTransition(async () => {
      ...
      await saldoAwalUpdate(id, formData).then((response) => {
        if (response.success) {
          dialogDispatch({
