...
export default function DocumentUpdateForm({ onClose, id }) {
  ...
  useEffect(() => {
    ...
    setInput({
      nama_jenis_dokumen: document.nama_jenis_dokumen,
      nomor_dokumen: document.nomor_dokumen,
      nik_npwp: document.nik_npwp,
      paspor: document.paspor,
      tanggal_dokumen: new Date(document.tanggal_dokumen)
        .toISOString()
        .split("T")[0],
      tanda_terima_dokumen: new Date(document.tanda_terima_dokumen)
        .toISOString()
        .split("T")[0],
      perihal_dokumen: document.perihal_dokumen,
      pengirim_dokumen: document.pengirim_dokumen,
      keaslian_dokumen: document.keaslian_dokumen,
      deskripsi_dokumen: document.deskripsi_dokumen,
      penerima: document.penerima,
      catatan_komentar: document.catatan_komentar,
      tag_dokumen: document.tag_dokumen,
      klasifikasi: document.klasifikasi,
      bahasa: document.bahasa,
      jenis_pajak: document.jenis_pajak,
      tahun_pajak: document.tahun_pajak,
      bulan_pajak: document.bulan_pajak,
    });
    setFile(base_url + document.file);
    handleChange("file", base_url + document.file);
    setIsOpen(true);
                ...
                <FileUploadInput
                  ...
                  onChange={(e) => {
                    ...
                    if (selectedFile) {
                      ...
                      handleChange("file", selectedFile.name);
                    }
                  }}
                  error={errors.file}
                  required={!file}
