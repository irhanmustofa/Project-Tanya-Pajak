    ...
    if (isExportExcel || isExportPdf) {
      if (clientState.length > 0) {
        ...
        dataExport.head = [
          ...
          "Nomor Surat",
          "Tanggal Mulai Keputusan",
          "Tanggal Akhir Keputusan",
          "Kantor Virtual",
          "Alamat Utama PKP",
        ];
        ...
        clientState.map((item) =>
          dataExport.body.push([
            ...
            item.lokasi_disewa === 1 ? "Ya" : "Tidak",
            dateShort(item.tanggal_mulai),
            dateShort(item.tanggal_berakhir),
            item.toko_retail === 1 ? "Ya" : "Tidak",
            item.kawasan_bebas === 1 ? "Ya" : "Tidak",
            item.kawasan_ekonomi_khusus === 1 ? "Ya" : "Tidak",
            item.tempat_penimbunan_berikat === 1 ? "Ya" : "Tidak",
            item.nomor_surat,
            dateShort(item.tanggal_awal_keputusan),
            dateShort(item.tanggal_akhir_keputusan),
            item.kantor_virtual === 1 ? "Ya" : "Tidak",
            item.alamat_utama_pkp === 1 ? "Ya" : "Tidak",
          ])
        );
