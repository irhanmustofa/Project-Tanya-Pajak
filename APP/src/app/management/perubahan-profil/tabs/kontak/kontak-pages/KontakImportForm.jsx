...
import { kontakClientImport } from "@/app/management/perubahan-profil/tabs/kontak/kontak-components/KontakService";
import {
  useClient,
  useClientDispatch,
} from "@/app/management/perubahan-profil/perubahan-profil-components/PerubahanProfilProvider";

export default function KontakImportForm({ onClose }) {
  ...
  const handleImportData = (event) => {
    ...
    startTrasition(() => {
      ...
      kontakClientImport(inputData).then((response) => {
        if (response.success) {
          dialogDispatch({
            type: dialogAction.DIALOG_INFO,
            payload: {
